...
// Source: github.com/stesla/telnet (interfaces: Conn,Option,Logger,EventSink,EventListener)
...
func (mr *MockConnMockRecorder) Role() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Role", reflect.TypeOf((*MockConn)(nil).Role))
}
...
func (mr *MockEventListenerMockRecorder) HandleEvent(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HandleEvent", reflect.TypeOf((*MockEventListener)(nil).HandleEvent), arg0)
}
